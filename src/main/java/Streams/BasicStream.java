...
public class BasicStream {
    ...
    public static void main(String[] args) {
        ...
        // 1. Filter
        // System.out.println(nums.stream().filter(i -> i%2 ==
        ...
        // System.out.println(empList.stream().collect(Collectors.groupingBy(Employee::getDesignation,Collectors.mapping(Employee::getId,
        // Collectors.toList()))));
        // 5.
        // System.out.println(empList.stream().collect(Collectors.groupingBy
        // (emp -> emp.getDesignation(), Collectors.counting())));
        ...
        // 7. groupingBy(classifier, supplier, collector) - returns map
        // System.out.println(empList.stream().collect(Collectors.groupingBy(emp ->
        // emp.getDesignation(),
        // LinkedHashMap::new,
        // Collectors.mapping(Employee::getName, Collectors.toList()))));

        // 8. Group by designation and return a map with designation -> Name or
        // department
        // System.out.println(empList.stream().collect(Collectors.groupingBy(Employee::getDesignation,
        // Collectors.mapping(emp -> emp.getDept().getDepartment(),
        // Collectors.toList()))));

        // 9. grouping by and then grouping by
        // System.out.println(empList.stream().collect(Collectors.groupingBy(Employee::getDesignation,
        ...
        // Arrays.asList(firstList,secondList,thirdList);

        // System.out.println(listOfListOfString.stream().flatMap(list ->
        ...
        // 14. filter then convert to uppercase then sort then print
...
class Employee {
    ...
    public static List<Employee> employees() {
        ...
        empList.add(new Employee(1, "Hary", new Department(21, "Sales"), "Manager"));
        empList.add(new Employee(2, "Hary", new Department(22, "Ops"), "Manager"));
        empList.add(new Employee(3, "Chris", new Department(23, "Sales"), "Senior Engineer"));
        empList.add(new Employee(4, "Martin", new Department(24, "Sales"), "Data Head"));
        empList.add(new Employee(5, "Ben", new Department(25, "Data"), "Assistant Manager"));
