...
public class BasicStream {
    ...
    public static void main(String[] args) {
        ...
        // System.out.println(empList.stream().collect(Collectors.groupingBy(Employee::getDesignation,Collectors.mapping(Employee::getId, Collectors.toList()))));
        //5.
        ...
        //8. Group by designation and return a map with designation -> Name or department
        // System.out.println(empList.stream().collect(Collectors.groupingBy(Employee::getDesignation, 
        //                                             Collectors.mapping(emp -> emp.getDept().getDepartment(), Collectors.toList()))));
